...
public class POSSystemPetShopModern extends JFrame {
	...
	textField2.setFont(new Font("Mv Boli", Font.PLAIN, 12));
	...
	txtEMailUsername.setFont(new Font("Mv Boli", Font.PLAIN, 12));
	txtEMailUsername.setText("E-mail / Username");
	txtEMailUsername.setBounds(446, 156, 201, 20);
	txtEMailUsername.setBorder(null);
	txtEMailUsername.setForeground(Color.BLACK);
	...
	btnLogin.setFont(new Font("Mv Boli", Font.BOLD, 11));
	...
	JButton btnReset = new JButton(" RESET");
		...
		btnReset.setFont(new Font("Mv Boli", Font.BOLD, 11));
		...
		lblNewLabel_6.setBounds(419, 153, 23, 23);
		...
		separator.setBounds(409, 114, 254, 2);
